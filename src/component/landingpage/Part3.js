...
function Part3() {
  return (
    <>
      <div  className="p-5 text-center d-flex flex-column justify-content-center align-items-center text-dark opacity-90 fadedbluebg" style={{borderRadius:"20px", minHeight:"70vh"}}>
        <div className="pb-5">
          <p className="fw-bold fs-6 color-redpink">DEEP DEEP POOLS</p>
        ...
        <div className="grid row p-2">
          <div className="col-12 col-md-4">
            <p className="fw-bold fs-6 color-redpink">TREASURY BALANCE</p>
            <h2 className="display-3 fw-bold p-1 text-light">$12.27M</h2>
          </div>
          <div className="col-12 col-md-4">
            <p className="fw-bold fs-6 color-redpink">MARKET CAP</p>
            <h2 className="display-3 fw-bold p-1 text-light">92.01M</h2>
          </div>
          <div className="col-12 col-md-4">
            <p className="fw-bold fs-6 color-redpink" >APY</p>
